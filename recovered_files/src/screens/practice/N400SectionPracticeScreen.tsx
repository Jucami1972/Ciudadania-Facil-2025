// src/screens/practice/N400SectionPracticeScreen.tsx// src/screens/practice/N400SectionPracticeScreen.tsx
...
export default N400SectionPracticeScreen;});  },    color: '#64748B',    fontWeight: '700',    fontSize: 14,  footerCounter: {  },    color: '#CBD5E1',  navButtonTextDisabled: {  },    color: '#1E40AF',    fontWeight: '600',    fontSize: 14,  navButtonText: {  },    opacity: 0.4,  navButtonDisabled: {  },    paddingHorizontal: 4,    paddingVertical: 8,    gap: 4,    alignItems: 'center',    flexDirection: 'row',  navButton: {  },    borderTopColor: '#F1F5F9',    borderTopWidth: 1,    backgroundColor: 'white',    paddingTop: 12,    paddingHorizontal: 20,    justifyContent: 'space-between',    alignItems: 'center',    flexDirection: 'row',  footer: {  // ─── FOOTER ──────────────  },    marginLeft: 8,    justifyContent: 'center',    alignItems: 'center',    borderRadius: 16,    height: 32,    width: 32,  variationAudioBtn: {  },    fontStyle: 'italic',    lineHeight: 20,    color: '#475569',    fontSize: 14,    flex: 1,  variationText: {  },    borderBottomColor: '#F1F5F9',    borderBottomWidth: 1,    paddingVertical: 8,    justifyContent: 'space-between',    alignItems: 'center',    flexDirection: 'row',  variationItem: {  },    marginBottom: 12,    color: '#334155',    fontWeight: '700',    fontSize: 13,  variationsLabel: {  },    borderColor: '#E2E8F0',    borderWidth: 1,    marginBottom: 16,    padding: 16,    borderRadius: 16,    backgroundColor: 'white',  variationsCard: {  },    color: '#64748B',    fontWeight: '600',    fontSize: 14,  variationsToggleText: {  },    paddingVertical: 4,    marginBottom: 12,    gap: 6,    alignItems: 'center',    flexDirection: 'row',  variationsToggle: {  // ─── VARIATIONS ──────────────  },    fontWeight: '600',    fontSize: 13,  playResponseText: {  },    alignSelf: 'flex-start',    borderRadius: 10,    paddingHorizontal: 12,    paddingVertical: 8,    gap: 6,    alignItems: 'center',    flexDirection: 'row',  playResponseButton: {  },    marginBottom: 12,    fontStyle: 'italic',    lineHeight: 20,    color: '#047857',    fontSize: 13,  answerTextEs: {  },    marginBottom: 4,    lineHeight: 22,    color: '#065F46',    fontSize: 15,  answerText: {  },    marginBottom: 8,    color: '#065F46',    fontWeight: '700',    fontSize: 14,  answerLabel: {  },    borderLeftColor: '#10B981',    borderLeftWidth: 4,    marginBottom: 16,    padding: 16,    borderRadius: 16,    backgroundColor: '#F0FDF4',  answerCard: {  },    fontWeight: '600',    fontSize: 14,  showAnswerText: {  },    marginBottom: 16,    borderRadius: 14,    borderStyle: 'dashed',    borderWidth: 1.5,    paddingVertical: 12,    gap: 8,    justifyContent: 'center',    alignItems: 'center',    flexDirection: 'row',  showAnswerButton: {  // ─── ANSWER ──────────────  },    lineHeight: 18,    color: '#92400E',    fontSize: 13,    flex: 1,  tipText: {  },    padding: 12,    borderRadius: 12,    backgroundColor: '#FFFBEB',    marginTop: 16,    gap: 8,    alignItems: 'flex-start',    flexDirection: 'row',  tipContainer: {  },    fontStyle: 'italic',    lineHeight: 22,    color: '#6B7280',    fontSize: 15,  questionTextEs: {  },    marginBottom: 8,    lineHeight: 26,    color: '#111827',    fontWeight: '700',    fontSize: 18,  questionText: {  },    justifyContent: 'center',    alignItems: 'center',    borderRadius: 20,    height: 40,    width: 40,  audioButton: {  },    fontWeight: '700',    fontSize: 12,  questionBadgeText: {  },    borderRadius: 12,    paddingVertical: 4,    paddingHorizontal: 12,  questionBadge: {  },    marginBottom: 16,    alignItems: 'center',    justifyContent: 'space-between',    flexDirection: 'row',  questionHeader: {  },    }),      },        elevation: 4,      android: {      },        shadowRadius: 16,        shadowOpacity: 0.08,        shadowOffset: { width: 0, height: 4 },        shadowColor: '#000',      ios: {    ...Platform.select({    marginBottom: 16,    padding: 20,    borderRadius: 20,    backgroundColor: 'white',  questionCard: {  // ─── QUESTION CARD ──────────────  },    paddingBottom: 20,    paddingTop: 20,    paddingHorizontal: 20,  scrollContent: {  },    flex: 1,  container: {  },    borderRadius: 2,    backgroundColor: 'white',    height: '100%',  progressBarFill: {  },    overflow: 'hidden',    marginTop: 12,    borderRadius: 2,    backgroundColor: 'rgba(255,255,255,0.25)',    height: 4,  progressBarContainer: {  },    marginTop: 1,    color: 'rgba(255,255,255,0.8)',    fontWeight: '500',    fontSize: 12,  headerSubtitle: {  },    color: 'white',    fontWeight: '700',    fontSize: 18,  headerTitle: {  },    flex: 1,    alignItems: 'center',  headerTitleContainer: {  },    justifyContent: 'center',    alignItems: 'center',    backgroundColor: 'rgba(255,255,255,0.2)',    borderRadius: 22,    height: 44,    width: 44,  backButton: {  },    alignItems: 'center',    justifyContent: 'space-between',    flexDirection: 'row',  headerContent: {  },    paddingBottom: 14,    paddingHorizontal: 20,  header: {  headerContainer: {},  },    backgroundColor: '#F8FAFC',    flex: 1,  safeArea: {const styles = StyleSheet.create({};  );    </View>      </View>        </TouchableOpacity>          />            color={currentIndex === questions.length - 1 ? '#CBD5E1' : '#1E40AF'}            size={24}            name="chevron-right"          <MaterialCommunityIcons          </Text>            Siguiente          >            ]}              currentIndex === questions.length - 1 && styles.navButtonTextDisabled,              styles.navButtonText,            style={[          <Text        >          ]}            currentIndex === questions.length - 1 && styles.navButtonDisabled,            styles.navButton,          style={[          disabled={currentIndex === questions.length - 1}          onPress={handleNext}        <TouchableOpacity        </Text>          {currentIndex + 1} / {questions.length}        <Text style={styles.footerCounter}>        </TouchableOpacity>          </Text>            Anterior          >            style={[styles.navButtonText, currentIndex === 0 && styles.navButtonTextDisabled]}          <Text          />            color={currentIndex === 0 ? '#CBD5E1' : '#1E40AF'}            size={24}            name="chevron-left"          <MaterialCommunityIcons        >          style={[styles.navButton, currentIndex === 0 && styles.navButtonDisabled]}          disabled={currentIndex === 0}          onPress={handlePrevious}        <TouchableOpacity      <View style={[styles.footer, { paddingBottom: Math.max(insets.bottom, 16) }]}>      {/* Navigation Footer */}      </ScrollView>        </Animated.View>          )}            </>              )}                </View>                  ))}                    </View>                      )}                        </TouchableOpacity>                          />                            color={sectionColor}                            size={16}                            name="volume-high"                          <MaterialCommunityIcons                        >                          disabled={isPlaying}                          style={styles.variationAudioBtn}                          onPress={() => handlePlayVariation(i)}                        <TouchableOpacity                      {variationsWithAudio[i] && (                      <Text style={styles.variationText}>"{v}"</Text>                    <View key={i} style={styles.variationItem}>                  {currentQuestion.variations.map((v, i) => (                  </Text>                    🔄 Otras formas de hacer esta pregunta:                  <Text style={styles.variationsLabel}>                <View style={styles.variationsCard}>              {showVariations && (              </TouchableOpacity>                </Text>                  {showVariations ? 'Ocultar variaciones' : `Ver ${currentQuestion.variations.length} variaciones`}                <Text style={styles.variationsToggleText}>                />                  color="#64748B"                  size={20}                  name={showVariations ? 'chevron-up' : 'chevron-down'}                <MaterialCommunityIcons              >                activeOpacity={0.8}                onPress={() => setShowVariations(!showVariations)}                style={styles.variationsToggle}              <TouchableOpacity            <>          {currentQuestion.variations.length > 0 && (          {/* Variations */}          )}            </View>              )}                </TouchableOpacity>                  </Text>                    Escuchar ejemplo de respuesta                  <Text style={[styles.playResponseText, { color: sectionColor }]}>                  />                    color={sectionColor}                    size={18}                    name={isPlaying ? 'volume-high' : 'play-circle'}                  <MaterialCommunityIcons                >                  disabled={isPlaying}                  style={[styles.playResponseButton, { backgroundColor: sectionColor + '15' }]}                  onPress={handlePlayResponse}                <TouchableOpacity              {hasResponseAudio && (              <Text style={styles.answerTextEs}>{currentQuestion.tipEs}</Text>              <Text style={styles.answerText}>{currentQuestion.tip}</Text>              <Text style={styles.answerLabel}>💬 Consejo de respuesta</Text>            <View style={styles.answerCard}>          {showAnswer && (          </TouchableOpacity>            </Text>              {showAnswer ? 'Ocultar consejo de respuesta' : 'Ver consejo de respuesta'}            <Text style={[styles.showAnswerText, { color: sectionColor }]}>            />              color={sectionColor}              size={20}              name={showAnswer ? 'eye-off' : 'eye'}            <MaterialCommunityIcons          >            activeOpacity={0.8}            onPress={() => setShowAnswer(!showAnswer)}            style={[styles.showAnswerButton, { borderColor: sectionColor }]}          <TouchableOpacity          {/* Show/Hide Answer */}          </View>            </View>              <Text style={styles.tipText}>{currentQuestion.tipEs}</Text>              <MaterialCommunityIcons name="lightbulb-outline" size={16} color="#F59E0B" />            <View style={styles.tipContainer}>            {/* Tip */}            <Text style={styles.questionTextEs}>{currentQuestion.questionEs}</Text>            <Text style={styles.questionText}>{currentQuestion.question}</Text>            </View>              )}                </TouchableOpacity>                  />                    color="white"                    size={20}                    name={isPlaying ? 'volume-high' : 'play'}                  <MaterialCommunityIcons                >                  disabled={isPlaying}                  style={[styles.audioButton, { backgroundColor: sectionColor }]}                  onPress={handlePlayQuestion}                <TouchableOpacity              {hasQuestionAudio && (              </View>                </Text>                  Pregunta {currentIndex + 1}                <Text style={[styles.questionBadgeText, { color: sectionColor }]}>              <View style={[styles.questionBadge, { backgroundColor: sectionColor + '15' }]}>            <View style={styles.questionHeader}>          <View style={styles.questionCard}>          {/* Question Card */}        <Animated.View style={{ opacity: fadeAnim }}>      >        showsVerticalScrollIndicator={false}        contentContainerStyle={styles.scrollContent}        style={styles.container}      <ScrollView      </View>        </LinearGradient>          </View>            />              ]}                { width: `${((currentIndex + 1) / questions.length) * 100}%` },                styles.progressBarFill,              style={[            <View          <View style={styles.progressBarContainer}>          {/* Progress Bar */}          </View>            <View style={{ width: 44 }} />            </View>              </Text>                {currentIndex + 1} de {questions.length}              <Text style={styles.headerSubtitle}>              <Text style={styles.headerTitle}>{sectionTitle}</Text>            <View style={styles.headerTitleContainer}>            </TouchableOpacity>              <MaterialCommunityIcons name="arrow-left" size={24} color="white" />            <TouchableOpacity onPress={() => navigation.goBack()} style={styles.backButton}>          <View style={styles.headerContent}>        >          style={[styles.header, { paddingTop: insets.top + 8 }]}          end={{ x: 1, y: 1 }}          start={{ x: 0, y: 0 }}          colors={[sectionColor, sectionColor + 'CC'] as [string, string]}        <LinearGradient      <View style={[styles.headerContainer, { backgroundColor: sectionColor }]}>      {/* Header */}      <StatusBar barStyle="light-content" translucent backgroundColor="transparent" />    <View style={styles.safeArea}>  return (  );    (_, i) => !!n400AudioMap[`${currentQuestion.id}_v${i + 1}`]  const variationsWithAudio = currentQuestion.variations.map(  const hasResponseAudio = !!n400AudioMap[`${currentQuestion.id}_resp`];  const hasQuestionAudio = !!n400AudioMap[currentQuestion.id];  // Check which audio files exist for this question  }    );      </View>        <Text style={{ color: '#718096' }}>No hay preguntas para esta sección.</Text>      <View style={[styles.safeArea, { justifyContent: 'center', alignItems: 'center' }]}>    return (  if (!currentQuestion) {  };    }      });        setShowVariations(false);        setShowAnswer(false);        setCurrentIndex((prev) => prev - 1);      animateTransition(() => {    if (currentIndex > 0) {  const handlePrevious = () => {  };    }      });        setShowVariations(false);        setShowAnswer(false);        setCurrentIndex((prev) => prev + 1);      animateTransition(() => {    if (currentIndex < questions.length - 1) {  const handleNext = () => {  };    });      }).start();        useNativeDriver: true,        duration: 200,        toValue: 1,      Animated.timing(fadeAnim, {      callback();    }).start(() => {      useNativeDriver: true,      duration: 150,      toValue: 0,    Animated.timing(fadeAnim, {  const animateTransition = (callback: () => void) => {  };    playAudio(`${currentQuestion.id}_resp`);    if (!currentQuestion) return;  const handlePlayResponse = () => {  };    playAudio(`${currentQuestion.id}_v${variationIndex + 1}`);    if (!currentQuestion) return;  const handlePlayVariation = (variationIndex: number) => {  };    playAudio(currentQuestion.id);    // Audio key = section_key + "_" + number (e.g., "id_1")    if (!currentQuestion) return;  const handlePlayQuestion = () => {  );    []    },      }        setIsPlaying(false);        if (__DEV__) console.error('Error playing audio:', error);      } catch (error) {        });          }            setIsPlaying(false);          if (status.isLoaded && status.didJustFinish) {        sound.setOnPlaybackStatusUpdate((status) => {        setIsPlaying(true);        soundRef.current = sound;        const { sound } = await Audio.Sound.createAsync(audioSource, { shouldPlay: true });        });          staysActiveInBackground: false,          playsInSilentModeIOS: true,        await Audio.setAudioModeAsync({        }          return;          if (__DEV__) console.warn('Audio not found:', audioKey);        if (!audioSource) {        const audioSource = n400AudioMap[audioKey];        }          soundRef.current = null;          await soundRef.current.unloadAsync();        if (soundRef.current) {        // Stop previous      try {    async (audioKey: string) => {  const playAudio = useCallback(  const currentQuestion = questions[currentIndex];  }, []);    };      }        soundRef.current.unloadAsync();      if (soundRef.current) {    return () => {  useEffect(() => {  // Cleanup audio on unmount  }, [sectionId]);    setShowVariations(false);    setShowAnswer(false);    setCurrentIndex(0);    setQuestions(qs);        : getQuestionsBySection(sectionId as N400Section);        ? [...n400Questions]      sectionId === 'all'    const qs =  useEffect(() => {  const sectionColor = sectionInfo?.color || '#1E40AF';  const sectionInfo = n400Sections.find((s) => s.id === sectionId || s.key === sectionKey);  // Get section color  const fadeAnim = useRef(new Animated.Value(1)).current;  const soundRef = useRef<Audio.Sound | null>(null);  const [isPlaying, setIsPlaying] = useState(false);  const [showVariations, setShowVariations] = useState(false);  const [showAnswer, setShowAnswer] = useState(false);  const [currentIndex, setCurrentIndex] = useState(0);  const [questions, setQuestions] = useState<N400Question[]>([]);  const { sectionId, sectionKey, sectionTitle } = route.params;  const insets = useSafeAreaInsets();  const route = useRoute<RouteProp<RouteParams, 'N400SectionPractice'>>();  const navigation = useNavigation<NavigationProps>();const N400SectionPracticeScreen = () => {};  };    sectionTitle: string;    sectionKey: string;    sectionId: string;  N400SectionPractice: {type RouteParams = {import { n400AudioMap } from '../../assets/audio/n400/n400AudioMap';} from '../../data/n400FormPractice';  getQuestionsBySection,  n400Sections,  N400Section,  N400Question,  n400Questions,import {import { NavigationProps } from '../../types/navigation';import { Audio } from 'expo-av';import { useSafeAreaInsets } from 'react-native-safe-area-context';import { LinearGradient } from 'expo-linear-gradient';import { MaterialCommunityIcons } from '@expo/vector-icons';import { useNavigation, useRoute, RouteProp } from '@react-navigation/native';} from 'react-native';  Animated,  Platform,  StatusBar,  ScrollView,  TouchableOpacity,  Text,  StyleSheet,  View,import {import React, { useState, useCallback, useEffect, useRef } from 'react';
              ...
              <View style={styles.resultSection}>
                ...
                <View style={styles.responsesCard}>
                  <Text style={styles.responsesTitle}>
                    <MaterialCommunityIcons name="message-reply-text" size={16} color="#1E40AF" /> Respuesta recomendada
                  </Text>
                  <TouchableOpacity
                    style={styles.responseRow}
                    onPress={() => {
                      const audioKey = `${currentQuestion.id}_resp`;
                      if (n400AudioMap[audioKey]) {
                        speakText(currentQuestion.recommendedResponseAudio, audioKey);
                      } else {
                        speakText(currentQuestion.recommendedResponseAudio);
                      }
                    }}
                    activeOpacity={0.7}
                  >
                    <View style={styles.responseContent}>
                      <Text style={styles.responseText}>{currentQuestion.recommendedResponse}</Text>
                    </View>
