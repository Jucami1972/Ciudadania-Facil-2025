...
export const readingWritingQuestions: ReadingWritingQuestion[] = [
  ...
  {
    id: 32,
    questionEn: "What do people want?",
    answerEn: "People want to be free.",
    category: "reading",
    subcategory: "B: Rights and Government",
  },
  {
    id: 33,
    questionEn: "Why do people come to America?",
    answerEn: "People come to America for freedom.",
    category: "reading",
    subcategory: "B: Rights and Government",
  },
  {
    ...
    answerEn: "George Washington was the first President.",
    category: "reading",
    subcategory: "C: History and Presidents",
  },
  {
    id: 35,
    questionEn: "Who elects the President of the United States?",
    answerEn: "Citizens of the United States elect the President.",
    category: "reading",
    subcategory: "B: Rights and Government",
  },
  {
    id: 36,
    questionEn: "Where has Abraham Lincoln lived?",
    answerEn: "Abraham Lincoln lived in the White House.",
    category: "reading",
    subcategory: "C: History and Presidents",
  },
  {
    id: 37,
    questionEn: "What is one right of a U.S. citizen?",
    answerEn: "Citizens have the right to vote.",
    category: "reading",
    subcategory: "B: Rights and Government",
  },
  {
    id: 38,
    questionEn: "What is one right in the United States?",
    answerEn: "People in the United States have the right of freedom of speech.",
    category: "reading",
    subcategory: "B: Rights and Government",
  },
  {
    id: 39,
    questionEn: "What do people pay to the government?",
    answerEn: "People pay taxes to the government.",
    category: "reading",
    subcategory: "B: Rights and Government",
  },
  {
    id: 40,
    questionEn: "What was the first U.S. capital?",
    answerEn: "New York City was the first U.S. capital.",
    category: "reading",
    subcategory: "A: Geography",
  },
  {
    id: 41,
    questionEn: "How many states do we have?",
    answerEn: "We have fifty states.",
    category: "reading",
    subcategory: "A: Geography",
  },
  {
    id: 42,
    questionEn: "How many Senators do we have?",
    answerEn: "We have one hundred Senators.",
    category: "reading",
    subcategory: "B: Rights and Government",
  },
  {
    id: 43,
    questionEn: "When do we vote for President?",
    answerEn: "We vote for President in November.",
    category: "reading",
    subcategory: "B: Rights and Government",
  },
  {
    id: 44,
    questionEn: "What is in the Bill of Rights?",
    answerEn: "The Bill of Rights has the first ten amendments.",
    category: "reading",
    subcategory: "B: Rights and Government",
  },
  {
    id: 45,
    questionEn: "How many U.S. Senators does Congress have?",
    answerEn: "Congress has one hundred U.S. Senators.",
    category: "reading",
    subcategory: "B: Rights and Government",
  },
  {
    id: 46,
    questionEn: "What was the first U.S. state?",
    answerEn: "Delaware was the first U.S. state.",
    category: "reading",
    subcategory: "A: Geography",
  },
  {
    id: 47,
    questionEn: "What President is on the dollar bill?",
    answerEn: "President George Washington is on the dollar bill.",
    category: "reading",
    subcategory: "C: History and Presidents",
  },
];
